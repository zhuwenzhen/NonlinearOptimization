...
\begin{centering}
\begin{aligned}
class 1 &\Leftrightarrow p(\mathbf{x}) = \frac{1}{1+e^{-\bm{\theta} \cdot \mathbf{x}}} > \frac{1}{2} \\
&\Leftrightarrow e^ {-\bm{\theta} \cdot \mathbf{x}} > 1\\
&\Leftrightarrow \bm{\theta} \cdot \mathbf{x} > 0\\
\end{aligned}
\\
\begin{aligned}
class 0 &\Leftrightarrow p(\mathbf{x}) = \frac{1}{1+e^{-\bm{\theta} \cdot \mathbf{x}}} < \frac{1}{2} \\
&\Leftrightarrow e^ {-\bm{\theta} \cdot \mathbf{x}} < 1\\
&\Leftrightarrow \bm{\theta} \cdot \mathbf{x} < 0\\
\end{aligned}
